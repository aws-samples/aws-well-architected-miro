...
export const handler = async (
    ...
    try {
        ...
        const workloadsBuilder = listWorkloadsResponse.WorkloadSummaries.map(
            async (workload) => {
                ...
                return {
                    ...
                    lenses: listLensesResponse.LensSummaries.filter((lens) => {
                        if (
                            lens.LensType === 'CUSTOM_SELF' ||
                            lens.LensType === 'CUSTOM_SHARED'
                        ) {
